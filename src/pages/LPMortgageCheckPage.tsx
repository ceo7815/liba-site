...
const LPMortgageCheckPage = () => {
  useClarityPageTags({ pageType: "landing-page", lpCampaign: "mortgage", funnelStep: "check" });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const payload = {
      ...
      meta_source_page: "lp-mortgage-insurance",
  ...
  return (
    <main className="min-h-screen bg-background" dir="rtl">
      <SEOHead
        title="בדיקת זכאות להוזלת ביטוח משכנתא | ליבה ביטוח ופנסיוני"
        description="מלאו את הפרטים ונבדוק אם אתם זכאים לחיסכון של עשרות אלפי שקלים על ביטוח המשכנתא שלכם. בדיקה חינמית וללא התחייבות."
        canonical="/lp/mortgage-insurance/check"
        noindex
      />
      ...
      <section className="relative py-16 md:py-20 overflow-hidden">
        <div className="absolute inset-0">
          <img src={heroBg} alt="בדיקת זכאות להוזלת ביטוח משכנתא" className="w-full h-full object-cover" />
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          <p className="text-primary-foreground/70">מלאו את הפרטים ונבדוק אם אתם זכאים להוזלה</p>
        </div>
      </section>
        ...
        >
          ...
          <div>
            <input
              ...
              aria-describedby={phoneError ? "phone-error-mortgage" : undefined}
              className={inputClass}
            />
            {phoneError && (
              <p id="phone-error-mortgage" className="text-destructive text-xs mt-1 px-1">{phoneError}</p>
            )}
          </div>
          <div>
            <input
              ...
              aria-describedby={idError ? "id-error-mortgage" : undefined}
              className={inputClass}
            />
            {idError && (
              <p id="id-error-mortgage" className="text-destructive text-xs mt-1 px-1">{idError}</p>
            )}
          </div>
...
export default LPMortgageCheckPage;
