...
const LPHealthKidsThankYouPage = () => {
  useClarityPageTags({ pageType: "landing-page", lpCampaign: "health-kids", funnelStep: "thank-you" });

  useEffect(() => { trackLead(); setClarityTag("lead_campaign", "health-kids"); trackClarityEvent("lead_submitted"); }, []);
  ...
  return (
    <main className="min-h-screen bg-background flex flex-col" dir="rtl">
      <SEOHead
        ...
        canonical="/lp/health-kids/thank-you"
        noindex
      />
...
export default LPHealthKidsThankYouPage;
